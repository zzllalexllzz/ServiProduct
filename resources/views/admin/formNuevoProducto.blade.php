        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class=" flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
                    <div>
                        <h3 class="dark:text-gray-300">AÑADIR PRODUCTO</h3>
                    </div>
                    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
                        <form method='POST' action='/producto/store' enctype="multipart/form-data">
                            ...
                            <!-- Categoria -->
                            <div>
                                <x-input-label for="cateproducto_id" :value="__('Categoria')" />
                                <select class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" id="cateproducto_id"  name="cateproducto_id" type="text" placeholder="" required>
                                    <option>Elige...</option>
